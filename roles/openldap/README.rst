...
.. zuul:rolevar:: openldap_operator_user
   :default: dragon

The user which will own the configuration directory.

.. zuul:rolevar:: openldap_operator_group
   :default: openldap_operator_user
...
.. zuul:rolevar:: openldap_docker_network_mtu
   :default: 1500

Set this to the MTU for your outside connection.

.. zuul:rolevar:: openldap_docker_registry_openldap
   :default: quay.io

The registry for the Openldap Docker container.

.. zuul:rolevar:: openldap_docker_registry_umc
   :default: quay.io
...
.. zuul:rolevar:: openldap_udm_rest_host
   :default: 127.0.0.1

The host where UDM will be reachable.

.. zuul:rolevar:: openldap_udm_rest_port
   :default: 9979

Port which UDM will use for connections.

.. zuul:rolevar:: openldap_udm_rest_container_name
   :default: udm-rest

Name of the container in which UDM will run.

.. zuul:rolevar:: openldap_udm_rest_tag
   :default: build-24328

Version from UDM which should used.

.. zuul:rolevar:: openldap_udm_rest_image
