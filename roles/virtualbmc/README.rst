...
.. zuul:rolevar:: virtualbmc_operator_user
   :default: dragon

The user which will own the configuration directory.

.. zuul:rolevar:: virtualbmc_operator_group
   :default: virtualbmc_operator_user
...
.. zuul:rolevar:: virtualbmc_docker_network_mtu
   :default: 1500

Set this to the MTU for your outside connection.

.. zuul:rolevar:: virtualbmc_docker_registry_virtualbmc
   :default: quay.io
