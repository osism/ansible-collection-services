...
def test_directories(host):
    ...
    for directory in directories:
        ...
        assert dir.user == get_variable(host, "virtualbmc_operator_user")
        assert dir.group == get_variable(host, "virtualbmc_operator_group")
...
def test_docker_compose_file(host):
    ...
    assert docker_compose_file.user == get_variable(host, "virtualbmc_operator_user")
    assert docker_compose_file.group == get_variable(host, "virtualbmc_operator_group")
