...
def test_repo(host):
    docker_configure_repository = get_variable(host, "containerd_docker_configure_repository")
    ...
    key_content = get_from_url(get_variable(host, "containerd_docker_debian_repository_key"))
